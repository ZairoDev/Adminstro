...
export async function POST(req: NextRequest) {  
  try {
    ...
    const [availableCount, notAvailableCount, upcomingCount] = await Promise.all([
      unregisteredOwnerShortTerm.countDocuments({ ...baseQuery, availability: "Available" }),
      unregisteredOwnerShortTerm.countDocuments({ ...baseQuery, availability: "Not Available" }),
      unregisteredOwnerShortTerm.countDocuments({
        ...baseQuery,
