...
const locationOptions = ["All","Athens", "Rome", "Milan", "Chania", "thessaloniki"];
...
const AreaPricePage = () => {
  ...
  const fetchAreaStats = async (selectedLocation: string) => {
    setLoading(true);
    try {
      const res = await axios.post("/api/areaPriceInfo", {
  ...
  const headings = [
    ...
    { key: "oneBedroomPrice", label: "1 Bedroom", sortable: true },
    { key: "twoBedroomPrice", label: "2 Bedroom", sortable: true },
    { key: "threeBedroomPrice", label: "3 Bedroom", sortable: true },
    { key: "studioPrice", label: "Studio", sortable: true },
  ];
    ...
    <div className="w-full min-h-screen bg-gray-200 dark:bg-stone-950 font-sans">
      <div className="w-full mx-auto p-6 bg-white dark:bg-stone-950 rounded-2xl shadow-xl border border-gray-100 dark:border-stone-900">
        ...
        <p className="mb-6 text-gray-500 dark:text-stone-400 text-sm">
          View area-wise bedroom and studio counts for each location. Use the
          search and sort features for quick access.
        </p>
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-6">
          ...
          <Input
            ...
            placeholder="Search area or price..."
            value={searchTerm}
              ...
              {filteredStats.length === 0 ? (
                <tr>
                  ...
                  >
                    {loading
                      ? "Loading..."
                      : "No data found for this location or search term."}
                  </td>
                </tr>
              ) : (
