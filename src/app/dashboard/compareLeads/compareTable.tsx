...
export default function CompareTable({ queries ,setQueries}: { queries: IQuery[] ,setQueries:Function}) {
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead>Lead Quality(LeadGen)</TableHead>
            <TableHead>Lead Quality(Sales)</TableHead>
            {/*  )}*/}
          ...
          {queries?.map((query, index) => (
            ...
            >
              ...
              {/* {(token?.role === "Sales-TeamLead" ||
                token?.role === "SuperAdmin") && ( */}
              <TableCell>
                <div>{query?.leadQualityByCreator}</div>
              </TableCell>

              <TableCell>
                <div>{query?.leadQualityByReviewer}</div>
              </TableCell>
              <TableCell>
                <p
