...
const OwnerClient = ({ owner }: { owner: OwnerInterface }) => {
  ...
  useEffect(() => {
    ...
    setField("phoneNumber", owner.phoneNumber);
  ...
  return (
    <div className=" w-full h-[90vh] grid justify-center items-center">
      <Card className="max-w-[450px]">
        ...
        <CardFooter className="flex justify-center">
          <Button onClick={handleUpdateOwner}>{isPending ? "Saving..." : "Save"}</Button>
        </CardFooter>
      </Card>
    </div>
  );
