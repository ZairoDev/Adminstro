          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="flex sm:p-4 flex-col gap-x-2">
              ...
              <div>
                    ...
                    item != "" && (
                      ...
                      >
                        <div className="flex items-center sm:flex-row flex-col justify-between gap-x-2 w-full border border-neutral-700 rounded-lg p-2">
                          <div className=" w-1/4">
                            {
                              property?.nearbyLocations?.nearbyLocationName[
                                index
                              ]
                            }
                          </div>
                          <div className=" w-1/4">
                            {
                              property?.nearbyLocations?.nearbyLocationDistance[
                                index
                              ]
                            }{" "}
                            m
                          ...
                          <div className=" w-1/4">
                            {
                              property?.nearbyLocations?.nearbyLocationTag[
                                index
                              ]
                            }
                          </div>
                          {property?.nearbyLocations?.nearbyLocationUrl?.[
                            index
                          ] != "" &&
                            property?.nearbyLocations?.nearbyLocationUrl?.[
                              index
                        ...
                        <Button
                          ...
                          className=" w-1/12"
                          onClick={() => {
                            const newObj = formData.nearbyLocations;
                ...
                {showAddLocation && (
                  <div className="flex items-center sm:flex-row flex-col mx-1 justify-between gap-x-2 w-full border border-neutral-700 rounded-lg p-2">
                    <div className=" w-1/4">
                      <Label>
                        Name{" "}
                        <Input
                    ...
                    <div className=" w-1/4">
                      <Label>
                        Distance{" "}
                        <Input
                          placeholder="Enter distance in metre"
                    ...
                    <div className="flex gap-x-2">
                      <div
                        className=" p-2 rounded-lg border border-neutral-700 cursor-pointer"
                        onClick={() => {
                          if (
                          ...
                          const newObj = formData.nearbyLocations;
                          newObj?.nearbyLocationName.push(
                            nearbyLocationInput?.nearbyLocationName
                          );
                          newObj?.nearbyLocationDistance.push(
                            nearbyLocationInput?.nearbyLocationDistance
                          );
                          newObj?.nearbyLocationTag.push(
                            nearbyLocationInput?.nearbyLocationTag
                          );
                          newObj?.nearbyLocationUrl?.push(
                            nearbyLocationInput?.nearbyLocationUrl
                          );
                          setFormData((prev) => ({
                            ...prev,
                ...
                <Button
                  ...
                  className=" mt-2"
                >
                  Add Locations <Plus className="h-5 w-5" />
                </Button>
              </div>
