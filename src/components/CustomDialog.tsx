    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[550px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a quick Lisitng if the property is not already available in the
            database
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex justify-between">
          <div className=" border border-slate-800 rounded-lg w-32 h-32 text-sm flex flex-col justify-center items-center">
            ...
            >
              ...
              />
              <img src={imageUrls[0]} className=" opacity-50 h-full w-full" />
            </label>
          </div>
