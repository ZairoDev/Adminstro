...
const PhoneInputLayout: React.ForwardRefExoticComponent<PhoneInputProps> = React.forwardRef<
...
const InputComponent = React.forwardRef<HTMLInputElement, any>(({ className, ...props }, ref) => (
  <input
    className={cn("rounded-e-lg rounded-s-none px-2 bg-background outline-none ", className)}
    {...props}
    ref={ref}
  />
));
