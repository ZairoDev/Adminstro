        ...
        <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
          ...
          <div style="padding: 40px 30px; color: #333; line-height: 1.8;">
            ...
            <div style="margin-top: 40px; padding-top: 25px; border-top: 1px solid #e5e7eb;">
              <p style="margin: 5px 0; font-size: 15px; color: #1f2937;">Warm regards,</p>
              <p style="margin: 5px 0; font-size: 16px; font-weight: 600; color: #2563eb;">${companyName} HR Team</p>
            </div>
          </div>
      ...
      html: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
          ...
          <div style="padding: 40px 30px; color: #333; line-height: 1.8;">
            ...
            <div style="margin-top: 40px; padding-top: 25px; border-top: 1px solid #e5e7eb;">
              <p style="margin: 5px 0; font-size: 15px; color: #1f2937;">Best regards,</p>
              <p style="margin: 5px 0; font-size: 16px; font-weight: 600; color: #10b981;">${companyName} Recruitment Team</p>
            </div>
          </div>
      ...
      html: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
          ...
          <div style="padding: 40px 30px; color: #333; line-height: 1.8;">
            ...
            <div style="margin-top: 40px; padding-top: 25px; border-top: 1px solid #e5e7eb;">
              <p style="margin: 5px 0; font-size: 15px; color: #1f2937;">Sincerely,</p>
              <p style="margin: 5px 0; font-size: 16px; font-weight: 600; color: #6b7280;">${companyName} Recruitment Team</p>
            </div>
          </div>
      ...
      html: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
          ...
          <div style="padding: 40px 30px; color: #333; line-height: 1.8;">
            ...
            <div style="margin-top: 40px; padding-top: 25px; border-top: 1px solid #e5e7eb;">
              <p style="margin: 5px 0; font-size: 15px; color: #1f2937;">Best regards,</p>
              <p style="margin: 5px 0; font-size: 16px; font-weight: 600; color: #8b5cf6;">${companyName} Recruitment Team</p>
            </div>
          </div>
...
export async function sendEmail(payload: EmailPayload) {
  try {
    ...
    const mailOptions = {
      from: `${
        payload.companyName || "Zairo International"
      } <zairo.domain@gmail.com>`,
      to: payload.to,
      subject,
      html,
    };
